...
public class CreditCardUtil {
    ...
    private static final int CARD_LENGTH_FOR_TYPE = 2;
    ...
    private static final Pattern REGX_UNKNOWN = Pattern.compile("^[0-9]{16}?");

    public static final Pattern TYPE_AMEX = Pattern.compile("^3[47][0-9]{2}$");
    public static final Pattern TYPE_VISA = Pattern.compile("^4[0-9]");
    public static final Pattern TYPE_MASTERCARD = Pattern.compile("^5[1-5]");
    ...
    public static final Pattern TYPE_UNKNOWN = Pattern.compile("^[0-9]{2}");
    ...
    public static final Card UNKNOWN = new Card(REGX_UNKNOWN, TYPE_UNKNOWN, new int[] { 4, 4, 4, 4 });
    ...
    public boolean isCardReal(CharSequence card) {
        String rawCard = clean(card);

        if(!validateCard(rawCard)) {
            return false;
        }

        if(isCardLuhnCompliant(rawCard)) {
            return true;
        }
    ...
    public static boolean isCardLuhnCompliant(CharSequence card) {
        boolean alt = false;
        float sum = 0;
